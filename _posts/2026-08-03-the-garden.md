...
Before talking about mathematics proper, I should specify what I mean by "feeling like a place". I actually have something of a definition[^armchair]:
...
Until recently, mathematicians-cartographers have been working mostly by hand, using simple methods that have existed for centuries, which sort of justified the diversification and specialization of labor. However, outsiders to the community have now come up with a tool that is much faster than humans at [mapping out the territory](https://cdn.openai.com/pdf/ten-proofs-oai.pdf), and has a much more complete map than anyone.
